...
This repository is the deep learning implementation for the paper "[Data Extrapolation from Learned Prior Images for Truncation Correction in Computed Tomography](https://ieeexplore.ieee.org/document/9400411)" (**In Updating**)
